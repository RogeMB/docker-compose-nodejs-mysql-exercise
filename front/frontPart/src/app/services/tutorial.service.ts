...
import { TutorialsResponse } from '../interfaces/tutorials.interface';
...
export class TutorialService {
  ...
  getTutorials():Observable<TutorialsResponse[]>{
    return this.http.get<TutorialsResponse []>(`${environment.api_base_url}api/tutorials`);
  }
